...
// PairPrice defines model for pairPrice.
type PairPrice struct {
	// Curr1 The first currency code
	Curr1 *string `json:"curr1,omitempty"`

	// Curr2 The second currency code
	Curr2 *string `json:"curr2,omitempty"`

	// Lprice The last price
	Lprice *string `json:"lprice,omitempty"`
}
