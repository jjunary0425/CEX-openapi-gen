...
func (c *Client) GetApiTickerSymbol1Symbol2(ctx context.Context, symbol1 string, symbol2 string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetApiTickerSymbol1Symbol2Request(c.Server, symbol1, symbol2)
	if err != nil {
		return nil, err
	}
...
func NewGetApiTickerSymbol1Symbol2Request(server string, symbol1 string, symbol2 string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/ticker/%s/%s", pathParam0, pathParam1)
	if operationPath[0] == '/' {
...
func (r GetApiTickerSymbol1Symbol2Response) Status() string {
...
func (r GetApiTickerSymbol1Symbol2Response) StatusCode() int {
	if r.HTTPResponse != nil {
...
func ParseGetApiTickerSymbol1Symbol2Response(rsp *http.Response) (*GetApiTickerSymbol1Symbol2Response, error) {
	...
	response := &GetApiTickerSymbol1Symbol2Response{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
